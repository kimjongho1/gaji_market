            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            <li class="active" data-filter="*">디지털기기</li>
                            <li data-filter=".oranges">가구/인테리어</li>
                            <li data-filter=".fresh-meat">생활가전</li>
                            <li data-filter=".vegetables">생활/주방</li>
                            <li data-filter=".fastfood">취미/게임</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/featured/feature-1.jpg">
                            <ul class="featured__item__pic__hover">
                                ...
                                <li><a href="${pageContext.request.contextPath}/mypage/keepusers"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="latest-product__text">
                        ...
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                ...
                                <c:forEach var="item" items="${cateGoods1}" varStatus="loop">
